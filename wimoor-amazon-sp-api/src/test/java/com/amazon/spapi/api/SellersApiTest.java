...
public class SellersApiTest {
    ...
    public void mytest() throws ApiException {
        AWSAuthenticationCredentials awsAuthenticationCredentials=AWSAuthenticationCredentials.builder()
                //IAM user的accessKeyId
                .accessKeyId("AKIA4UNYCJAQ2NVTNAPN")
                //IAM user的secretKey
                .secretKey("tm9iswqI2c74krrhpYDseU/Pu2uERszI70SOoVrC")
                //这里按照amazon对不同region的分区填写，例子是北美地区的
                .region("us-east-1")
                .build();
        AWSAuthenticationCredentialsProvider awsAuthenticationCredentialsProvider=AWSAuthenticationCredentialsProvider.builder()
               //IAM role，特别注意：最好用IAM role当做IAM ARN去申请app
                // 而且IAM user需要添加内联策略STS关联上IAM role，具体操作看：https://www.spapi.org.cn/cn/model2/_2_console.html
                .roleArn("arn:aws:iam::868506290209:role/SellerPartnerAPI")
                .roleSessionName("myrolesessioname121231313")
                .build();
        LWAAuthorizationCredentials lwaAuthorizationCredentials = LWAAuthorizationCredentials.builder()
                //申请app后LWA中的clientId
                .clientId("amzn1.application-oa2-client.a900efc615854bb2a61ed8362bdd3da9")
                //申请app后LWA中的clientSecret
                .clientSecret("6d300f255a11a944aaa8893ec4b81f24c006a0cce1c77fe12f25f047eca03c0a")
                //店铺授权时产生的refreshToken或者app自授权生成的
                .refreshToken("Atzr|IwEBILgV2UEU2qRflh4-ERR2nFlsoXjHireLd6lC2zg0Y57-ywOvx04gwQMVkS3Ah4LDc0LPqPE2eomketYonuUlFOlmfCIAktaQ3Ar-Z1IWI4ym8kd5skDSx7XvmvZu1nUlCg41A55xRqqU66xSXPkV1KSF3kJsqtdQZgVW_dOcDNbrK7b8ffL5Naho92jU_4HS4T-Q2QUyeCtCBn7hM4TP9QPUGzZ4HP4A4BUhLCjRFsEVMiDqZ0xsk6nnZWnFy9MdTODtmqU-_ocxWTru9z_0hvU-qhujCGyWYYagkTiz1_a6mo1iOeXZ0RFTIZwyEqbcrok")
                .endpoint("https://api.amazon.com/auth/o2/token")
                .build();
        SellersApi sellersApi = new SellersApi.Builder()
                .awsAuthenticationCredentials(awsAuthenticationCredentials)
